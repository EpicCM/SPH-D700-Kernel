...
typedef enum {
    ...
    DTUN_METHOD_DM_SEND_SET_TX_CARRIER_FREQUENCY,
...
#elif GA_BLUETOOTH_ARIES_Q
#define DTUN_DEFAULT_DEV_NAME "GT-I9050"
#elif GA_BLUETOOTH_APOLLO
#define DTUN_DEFAULT_DEV_NAME "GT-I5801"
#else
#define DTUN_DEFAULT_DEV_NAME "My Android Phone"
#endif
*/
...
//SEC_BLUETOOTH start
#define DTUN_DEFAULT_DEV_NAME "Epic 4G" //ssuna_DF27 "Samsung Mobile"//jhee_DF09 temp
//SEC_BLUETOOTH end
