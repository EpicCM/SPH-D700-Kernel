...
DBusConnection *
dbus_obex_connection_ref (DBusConnection *connection)
{
  _dbus_return_val_if_fail (connection != NULL, NULL);
  _dbus_return_val_if_fail (connection->generation == _dbus_current_generation, NULL);
...
// start brcm ryu 2010.06.02
void
dbus_obex_connection_unref (DBusConnection *connection)
{
  dbus_bool_t last_unref;
...
// start brcm ryu 2010.06.02
dbus_bool_t
dbus_connection_get_obex_is_connected (DBusConnection *connection)
{
  dbus_bool_t res;
...
// start brcm ryu 2010.06.02
dbus_bool_t
dbus_connection_register_obex_object_path (DBusConnection              *connection,
                                      const char                  *path,
                                      const DBusObjectPathVTable  *vtable,
                                      void                        *user_data)
{
...
// start brcm ryu 2010.06.02
dbus_bool_t
dbus_connection_unregister_obex_object_path (DBusConnection              *connection,
                                        const char                  *path)
{
  char **decomposed_path;
  ...
  _dbus_obex_object_tree_unregister_and_unlock (connection->objects, (const char **) decomposed_path);
...
// start brcm ryu 2010.06.02
dbus_bool_t
dbus_connection_get_obex_object_path_data (DBusConnection *connection,
                                      const char     *path,
                                      void          **data_p)
{
  char **decomposed_path;
