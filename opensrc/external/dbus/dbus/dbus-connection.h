...
DBusConnection*    dbus_obex_connection_ref                          (DBusConnection             *connection);
// end brcm ryu
void               dbus_connection_unref                        (DBusConnection             *connection);
// start brcm ryu 2010.06.02
void               dbus_obex_connection_unref                        (DBusConnection             *connection);
// end brcm ryu
void               dbus_connection_close                        (DBusConnection             *connection);
dbus_bool_t        dbus_connection_get_is_connected             (DBusConnection             *connection);
// start brcm ryu 2010.06.02
dbus_bool_t        dbus_connection_get_obex_is_connected             (DBusConnection             *connection);
// end brcm ryu
