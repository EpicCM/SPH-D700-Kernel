...
// SecFeature SLOT0
            byte[][] hostAddresses;
            hostAddresses = getaddrinfo(host);
            if(hostAddresses == null) throw new UnknownHostException();
// SecFeature SLOT0

            InetAddress[] addresses = bytesToInetAddresses(hostAddresses, host); // SecFeature SLOT0
