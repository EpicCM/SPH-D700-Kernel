...
//SecFeature shiks_DJ12 blocked from Eclair start
/*
#ifdef SWP1_BLUETOOTH_ARIES
#ifdef S1_NTT
#define DTUN_DEFAULT_DEV_NAME "SC-02B"
#else
#define DTUN_DEFAULT_DEV_NAME "Galaxy S"
#endif
#else
#define DTUN_DEFAULT_DEV_NAME "My Android Phone"
#endif
*/
//SecFeature shiks_DJ12 blocked from Eclair end

//SecFeature shiks_DJ12 added from Eclair start
#define DTUN_DEFAULT_DEV_NAME "Epic 4G"
//SecFeature shiks_DJ12 added from Eclair end
...
#endif
#define DTUN_PORT 19000 //jhee_DJ04  //ticket #20971
...
typedef struct
{
	...
	uint32_t	    modulation;
	uint32_t	    txpower;
	uint32_t	    txpower_dbm;
	uint32_t	    txpower_index;
} tDTUN_METHOD_DM_SEND_SET_TX_CARRIER_FREQUENCY;
...
//SecFeature shiks_DK25 start
    tDTUN_METHOD_DM_SEND_SET_TX_CARRIER_FREQUENCY	send_set_tx_carrier_frequency;
//SecFeature shiks_DK25 end
