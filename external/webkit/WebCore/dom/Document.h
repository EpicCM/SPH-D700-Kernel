...
//SanJose++
    void addListenerTypeIfNeeded(const AtomicString& eventType, bool isPlugin);
    bool hasPluginTouchListeners() {
        return m_hasPluginTouchListeners;
    }
    bool hasOtherTouchListeners() {
        return m_hasOtherTouchListeners;
    }
//SanJose--
...
//SanJose++
    bool m_hasPluginTouchListeners;
    bool m_hasOtherTouchListeners;
//SanJose--
